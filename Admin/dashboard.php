...
// Fetch count of lots that are not sold
$unsoldLotsQuery = "SELECT COUNT(*) as unsoldLots FROM lotlist WHERE auction_number = ? AND sold_for_amt = 0.00";
...
<head>
  ...
  <title>Auction Dashboard - <?php echo htmlspecialchars($auctionDetails['auction_name']); ?></title>
...
<body>
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <h1 class="h3 mb-4 text-gray-800"><?php echo htmlspecialchars($auctionDetails['auction_name']); ?></h1>
      <h1 class="h3 mb-4 text-gray-800">Total Earnings - N$<?php echo number_format($totalEarnings, 2); ?></h1>
  ...
  <div class="stat-card bg-primary text-white">
    <div class="row no-gutters align-items-center">
      <div class="col mr-2">
        ...
        <div class="stat-value"><?php echo $biddersData['totalBidders']; ?></div>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="stat-card bg-success text-white">
    <div class="row no-gutters align-items-center">
      <div class="col mr-2">
        ...
        <div class="stat-value"><?php echo $ActiveBiddersData['activeBidders']; ?></div>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="stat-card bg-danger text-white">
    <div class="row no-gutters align-items-center">
      <div class="col mr-2">
        ...
        <div class="stat-value"><?php echo $inactiveBiddersData['inactiveBidders']; ?></div>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="stat-card bg-info text-white">
    <div class="row no-gutters align-items-center">
      <div class="col mr-2">
        ...
        <div class="stat-value"><?php echo $lotsData['totalLots']; ?></div>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="stat-card bg-warning text-white">
    <div class="row no-gutters align-items-center">
      <div class="col mr-2">
        ...
        <div class="stat-value"><?php echo $soldLotsData['soldLots']; ?></div>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="stat-card bg-secondary text-white">
    <div class="row no-gutters align-items-center">
      <div class="col mr-2">
        ...
        <div class="stat-value"><?php echo $unsoldLotsData['unsoldLots']; ?></div>
      </div>
    </div>
  </div>
</div>
