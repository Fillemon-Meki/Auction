...
if (isset($_POST['save'])) {
    ...
    $bankingDetails = $_POST['bankingDetails'];
    ...
    $query = mysqli_query($conn, "INSERT INTO auctiondetails (auction_code, auction_name, deposit_amount, region, town, date_of_auction, start_date_time, end_date_time, banking_details, terms_and_conditions, qr_1, qr_2, qr_3)
                             VALUES ('$auctionCode', '$auctionName', '$depositAmount', '$region', '$town', '$dateOfAuction', '$startTime', '$endTime', '$bankingDetails', '$termsAndConditions', '$registrationURL', '$lotsURL', '$selfRegistrationURL')");
